...
function PadMakerDialog() {
	...
	function addLayers() {
		...
		for (var i = 0; i < selLayers.length; i++) {
			...
			excludeLayerBtn.leftClick.onClick = function () {
				...
				D9T_MAKER_w.layout.layout(true);
	...
	// Janela principal
	var D9T_MAKER_w = new Window('palette', scriptName + ' ' + scriptVersion);
	D9T_MAKER_w.orientation = 'row';
	D9T_MAKER_w.alignChildren = ['center', 'top'];

	// ----------------------------------------------------------------------------

	var layoutMainGrp1 = D9T_MAKER_w.add('group');
...
em caso de dúvidas, problemas ou sugestões, mande uma mensagem pelo teams...\n\njean.billard';
	...
	var newDiv = themeDivider(D9T_MAKER_w);
	newDiv.alignment = ['center', 'fill'];

	// ----------------------------------------------------------------------------

	var layoutMainGrp2 = D9T_MAKER_w.add('group');
	...
	newDiv = new themeDivider(D9T_MAKER_w);
	newDiv.alignment = ['center', 'fill'];

	// ----------------------------------------------------------------------------

	// Cria um grupo para o cabeçalho da árvore de templates
	var layoutGrp3 = D9T_MAKER_w.add('group');
	...
	// Cria um grupo para o cabeçalho da árvore de templates
	var layoutGrp4 = D9T_MAKER_w.add('group');
	...
	setBgColor(D9T_MAKER_w, bgColor1);

	// ----------------------------------------------------------------------------

	D9T_MAKER_w.onClose = function () {
