    ...
    Logic.loadSettings = function () {
        ...
        if (configFile.exists) {
            try {
                ...
                configFile.close();
                if (centralConfig.tool_settings && centralConfig.tool_settings.icons4u) {
                    finalConfig = centralConfig.tool_settings.icons4u;
                }
            } catch (e) { }
        }
