...
function d9TemplateDialog() {
	...
	if (validProductions.length === 0) {
		validProductions = [{ name: 'JORNAIS', icon: 'D9T_TEMPPECAS_ICON', paths: [] }, { name: 'PROMO', icon: 'D9T_PROMO_ICON', paths: [] }, { name: 'PROGRAMAS', icon: 'D9T_PROGRAMAS_ICON', paths: [] }, { name: 'EVENTOS', icon: 'D9T_EVENTOS_ICON', paths: [] }, { name: 'MARKETING', icon: 'D9T_MARKETING_ICON', paths: [] }, { name: 'BASE TEMÁTICA', icon: 'D9T_TBASE_ICON', paths: [] }, { name: 'ILUSTRAÇÕES', icon: 'D9T_TILUSTRA_ICON', paths: [] }, ];
		prodDropItems = ['JORNAIS', 'PROMO', 'PROGRAMAS', 'EVENTOS', 'MARKETING', 'BASE TEMÁTICA', 'ILUSTRAÇÕES'];
	}
	// ===============================================
	...
	function populateListFromData(listBox, dataArray) {
		...
		for (var j = 0; j < allItems.length; j++) {
			...
			// Armazena os dados no item da lista para uso posterior
	...
	loadingWin.close(); // Fecha a janela de carregamento
