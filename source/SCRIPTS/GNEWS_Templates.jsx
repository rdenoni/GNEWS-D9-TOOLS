...
function d9TemplateDialog() {
    ...
    try {
        ...
        // Configura eventos dos botões usando sistema de tema
        function setupButtonClick(btn, func) {
            if (btn && typeof btn.leftClick !== "undefined") {
        ...
        setupButtonClick(refreshBtn, handleRefresh);
        setupButtonClick(openFldBtn, openTemplatesFolder);
        setupButtonClick(openBtn, executeOpen);
        setupButtonClick(importBtn, executeImport);
        
        setupButtonClick(infoBtn, function() {
            try {
