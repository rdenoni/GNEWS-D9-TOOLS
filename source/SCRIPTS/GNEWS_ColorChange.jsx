...
*
* SCRIPT CHANGE COLOR
* Versão: 13.7 (Estrutura corrigida para inclusão)
*
********************************************************************************/
...
function launchColorChange() {
    ...
    var colorPresets = [
        ...
        // ... (o restante da sua lista de presets continua aqui) ...
    ...
    // ... (todas as outras funções como analyzeLayers, applyColorChangeToComps, showColorChangeHelp, etc. permanecem aqui dentro) ...
        ...
        applyBtn.onClick = function() {
            ...
            if (compsToProcess.length === 0) { 
                ...
                if (activeComp && activeComp instanceof CompItem) {
                    ...
                    updateStatus("Selecione uma composição.", "warning"); return;
                }
            }
